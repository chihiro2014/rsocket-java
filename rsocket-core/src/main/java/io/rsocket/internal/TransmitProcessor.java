...
abstract class TransmitProcessorPadding01<T> extends FluxProcessor<T, T>
...
abstract class TransmitProcessorPadding02<T> extends TransmitProcessorPadding01<T> {
    
    volatile long p00, p01, p02, p03, p04, p05, p06, p07;
    volatile long p08, p09, p0A, p0B, p0C, p0D, p0E;
}

public final class TransmitProcessor<T> extends TransmitProcessorPadding02<T> {
    
    private static final RuntimeException CANCELLED = new RuntimeException("Cancelled");
