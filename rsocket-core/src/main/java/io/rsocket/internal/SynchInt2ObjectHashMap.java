 ...
 */
public class SynchInt2ObjectHashMap<V> implements Map<Integer, V>, Serializable {
  ...
  public SynchInt2ObjectHashMap() {
    this(MIN_CAPACITY, DEFAULT_LOAD_FACTOR, true);
  }

  public SynchInt2ObjectHashMap(final int initialCapacity, final float loadFactor) {
   ...
   */
  public SynchInt2ObjectHashMap(final SynchInt2ObjectHashMap<V> mapToCopy) {
  ...
  protected synchronized V getMapped(final int key) {
    final int mask = values.length - 1;
    int index = hash(key, mask);
  ...
  public synchronized V computeIfAbsent(
      final int key, final IntFunction<? extends V> mappingFunction) {
  ...
  /** {@inheritDoc} */
  public synchronized V put(final Integer key, final V value) {
  ...
  /** {@inheritDoc} */
  public synchronized void putAll(final Map<? extends Integer, ? extends V> map) {
  ...
  /** {@inheritDoc} */
  public synchronized KeySet keySet() {
    if (null == keySet) {
      keySet = new KeySet();
    }
  ...
  /** {@inheritDoc} */
  public synchronized ValueCollection values() {
  ...
  /** {@inheritDoc} */
  public synchronized EntrySet entrySet() {
    if (null == entrySet) {
   ...
   *     mapping for the key.
   */
  public synchronized V replace(final int key, final V value) {
    V curValue = get(key);
    if (curValue != null) {
   ...
   */
  public synchronized boolean replace(final int key, final V oldValue, final V newValue) {
  ...
  public final class KeySet extends AbstractSet<Integer> implements Serializable {
    ...
    public int size() {
      return SynchInt2ObjectHashMap.this.size();
    }

    public boolean contains(final Object o) {
      return SynchInt2ObjectHashMap.this.containsKey(o);
    }

    public boolean contains(final int key) {
      return SynchInt2ObjectHashMap.this.containsKey(key);
    }

    public boolean remove(final Object o) {
      return null != SynchInt2ObjectHashMap.this.remove(o);
    }

    public boolean remove(final int key) {
      return null != SynchInt2ObjectHashMap.this.remove(key);
    }

    public void clear() {
      SynchInt2ObjectHashMap.this.clear();
    }
  }
  ...
  public final class ValueCollection extends AbstractCollection<V> implements Serializable {
    ...
    public boolean contains(final Object o) {
      return SynchInt2ObjectHashMap.this.containsValue(o);
    }
  ...
  public final class EntrySet extends AbstractSet<Entry<Integer, V>> implements Serializable {
    ...
    public EntryIterator iterator() {
      synchronized (SynchInt2ObjectHashMap.this) {
  ...
  abstract class AbstractIterator<T> implements Iterator<T>, Serializable {
    ...
    protected final void findNext() {
      ...
      final Object[] values = SynchInt2ObjectHashMap.this.values;
      final int mask = values.length - 1;
    ...
    final void reset() {
      remaining = SynchInt2ObjectHashMap.this.size;
      final Object[] values = SynchInt2ObjectHashMap.this.values;
    ...
    private Entry<Integer, V> allocateDuplicateEntry() {
      ...
      return new Entry<Integer, V>() {
        ...
        public V setValue(final V value) {
          return SynchInt2ObjectHashMap.this.put(k, value);
        }
