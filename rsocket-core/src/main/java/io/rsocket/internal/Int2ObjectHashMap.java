...
/**
 * {@link java.util.Map} implementation specialised for int keys using open addressing and linear
 * probing for cache efficient access.
 *
 * @param <V> type of values stored in the {@link java.util.Map}
 */
public class Int2ObjectHashMap<V>implements Map<Integer, V>, Serializable {
     ...
     * java.util.function.IntFunction} and put it in the map.
     *
     * <p>Primitive specialized version of {@link java.util.Map#computeIfAbsent}.
     *
